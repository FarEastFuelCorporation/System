document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const user = username_data_list.content[23][findTextInArray(username_data_list, "NAME")];

        users.forEach(user => {user.value = username_data_list.content[23][findTextInArray(username_data_list, "NAME")]})
        user_sidebar.innerHTML = `<u>${username_data_list.content[23][findTextInArray(username_data_list, "NAME")]}</u>`;
        user_sidebar_officer.innerText = username_data_list.content[23][findTextInArray(username_data_list, "SECTIONS")];
        user_sidebar_department.innerText = username_data_list.content[23][findTextInArray(username_data_list, "DEPARTMENT")];
