document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        irf_user.value = username_data_list.content[xValue][findTextInArray(username_data_list, "NAME")];
        ...
        for(let x = 1; x < prf_data_list.content.length; x++){
            if(prf_data_list.content[x][findTextInArray(prf_data_list, "STATUS")] == "PURCHASED"){
                ...
                var button = `
                <form action="https://script.google.com/macros/s/AKfycbzQpg9QeysE02m_rQBIJXBoiFJXepIabJsUA3R5ZL393xuR3RpdBu8cr5qyKCYqHLfx/exec" method="post">
