document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const tin_no_update_client_form = update_client_form_tab_client_list_section.querySelector("#tin_no");
        ...
        const biller_nature_of_business_update_client_form = update_client_form_tab_client_list_section.querySelector("#biller_nature_of_business");
        const biller_tin_no_update_client_form = update_client_form_tab_client_list_section.querySelector("#biller_tin_no");
        ...
        search_client_id_button_update_client_form.addEventListener("click", () => {
            for(let x = 1; x < client_data_list.content.length; x++){
                if(search_client_id_update_client_form.value == client_data_list.content[x][findTextInArray(client_data_list, "CLIENT ID")]){
                    ...
                    tin_no_update_client_form.value = client_data_list.content[x][findTextInArray(client_data_list, "TIN ID")];
                    ...
                    biller_nature_of_business_update_client_form.value = client_data_list.content[x][findTextInArray(client_data_list, "BILLER NATURE OF BUSINESS")];
                    biller_tin_no_update_client_form.value = client_data_list.content[x][findTextInArray(client_data_list, "BILLER TIN ID")];
